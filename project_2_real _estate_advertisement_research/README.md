**Research of Apartment Sale Advertisements**
- Description:
I have an archive of apartment sale advertisements in St. Petersburg and neighboring settlements for several years at my disposal. It is necessary to determine the parameters that have the greatest influence on the valuation of real estate cost.
- Tools:
Pandas, Matplotlib, Seaborn, NumPy, Datetime.
Exploratory data analysis, data preprocessing, visualization.
- Goal:
Determine the parameters that have the greatest influence on the valuation of real estate cost.
- Conclusions:
The following parameters have the greatest influence on the price (in decreasing order of significance): area, number of rooms, distance from the center, floor.
- Project Status:
Completed.
